...
public class ImageGetter
{
     ...
     *         error occurs.
     */
    @BindingFunction("snapMicroscopeImage")
    ...
    /**
     * Use this method to only get the data of a snapped image. Uses a short array.
     * 
     * @param core
     ...
     * @param core
     *        : reference to actual core
     * @return Returns the last image in the core buffer as a MicroscopeImage. Returns null if an
     *         error occurs
     *         (mostly when acquisition sequence has not yet been run).
     */
    @BindingFunction("getImageFromLiveAcquisition")
    public static MicroscopeImage getImageFromLive(MicroscopeCore core)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                {
                    System.out.println("Dont' know how to handle images with " + core.getBytesPerPixel()
                            + " byte pixels.");
                    return null;
                }
            }
