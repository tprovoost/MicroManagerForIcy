...
/**
 * This class is an helper for the developer/scripter who wants to move the XY or Z stage.
 * 
...
public class StageMover
{
    ...
    /**
     * Moves the current stage on the X and Y axes relative to actual position.
     * 
     * @param movX
     *        : movement on X-Axis (in µm)
     * @param invertX
     ...
     * @param waitStage
     *        : whether should wait the stage or not (can drastically reduce acquisition speed).
     * @throws Exception
     */
    ...
    /**
     * Moves the current stage on the X and Y axes to the absolute position given by posX
     * and posY. <br/>
     * <br/>
     * <b>Warning:</b> this method will not wait for the stage to be in
     * position when this method ends.
     * 
     * @param posX
     *        : x position wanted
     * @param posY
    ...
    /**
     * Returns if Z-Axis/Focus Device is inverted.
     * 
     * @return
     */
    ...
    /**
     * Set this to true if your camera is rotated by 90°.
     */
    ...
    /**
     * Method automatically called when a stage position is changed.
     * 
     * @param s
     *        : the stage name that moved (XY or Focus)
     * @param z
     *        : the new value
     */
     ...
     *        : the stage name that moved (XY or Focus)
     * @param z
     *        : the new value, relative to the previous one.
     */
    ...
    /**
     * Method automatically called when the XY stage position is changed.
     * 
     * @param s
     *        : the XY stage name that moved
     * @param x
     *        : the new value x
     * @param y
     *        : the new value y
     ...
     *        : the XY stage name that moved
     * @param x
     *        : the new value x, relative to the previous
     * @param y
     *        : the new value y, relative to the previous
     */
