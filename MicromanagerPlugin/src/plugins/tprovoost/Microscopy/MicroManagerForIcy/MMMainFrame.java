...
/**
 * Main frame for Micro Manager Plugin (Singleton pattern). Please use the method
 * {@link MMMainFrame#getInstance()} to automatically display the loading frame with the different
 * configurations. <br/>
 * <br/>
 * Please look at MicroscopePlugin class for the creation a new plugin using MicroManagerForIcy.
 * 
 * @author Thomas Provoost
 * @see MicroscopePlugin
 */
public class MMMainFrame extends IcyFrame implements ScriptInterface
{
    ...
    private RunningProgress continuousProgress;
    /**
    ...
    /**
     * Singleton pattern : private constructor Use {@link MMMainFrame#getInstance()} instead.
     */
    private MMMainFrame()
    {
                                    ...
                                    public JMenu getMenu()
                                    {
                                        ...
                                        hconfig.addActionListener(new ActionListener()
                                        {
                                            ...
                                            public void actionPerformed(ActionEvent e)
                                            {
                                                ...
                                                ConfiguratorDlg configurator = new ConfiguratorDlg(mCore,
                                                        _sysConfigFile);
                                ...
                                addFrameListener(new IcyFrameAdapter()
                                {
                                    ...
                                    public void icyFrameClosing(IcyFrameEvent e)
                                    {
                                        if (getInternalFrame().getDefaultCloseOperation() == WindowConstants.DO_NOTHING_ON_CLOSE)
                                        {
                                            ...
                                            {
                                                if (!ConfirmDialog
                                                        .confirm("Some plugins are still running. Are you sure you want to close this ?"))
                                                    return;
                                            }
    ...
    public boolean waitForInstance()
    {
                        ...
                        public void run()
                        {
                            if (advancedDlg.waitingForObjectiveChange)
                            {
                                                ...
                                                + "</b></div>   as your Objective Turret configuration ?</html>"))
                                {
                                    ...
                                    if (res != null)
                                        advancedDlg.lblCurrentObjectiveTurretGroup.setText("<html><b>" + res
                                                + "</b></html>");
                                }
                            ...
                            else if (advancedDlg.waitingForBlockChange)
                            {
                                                ...
                                                + "</b></div>  as your Filter Block configuration ?</html>"))
                                {
                                    ...
                                    if (res != null)
                                        advancedDlg.lblCurrentFilterBLockGroup.setText("<html><b>" + res
                                                + "</b></html>");
                                }
     ...
     */
    private void savePresets(String filename)
    {
        if (filename == null)
            return;
        XMLPreferencesRoot root = new XMLPreferencesRoot(filename);
    ...
    @Override
    public void openAcquisition(String s, String s1, int i, int j, int k, int l, boolean flag, boolean flag1)
    ...
    @Override
    public void openAcquisition(String s, String s1, int i, int j, int k, boolean flag, boolean flag1)
            throws MMScriptException
    {
        // TODO Auto-generated method stub
