...
public class MMAcquisitionEngineMT implements AcquisitionEngine, ViewerListener {
	...
	public MMAcquisitionEngineMT(MicroscopePluginAcquisition plugin, CMMCore core, MMMainFrame gui) {
		_plugin = plugin;
		singleFrame_ = false;
		singleWindow_ = false;
		cameraConfig_ = "";
	...
	public void setCore(CMMCore c, AutofocusManager _afMgr) {
		_core = (MicroscopeCore) c;
		afMgr_ = _afMgr;
