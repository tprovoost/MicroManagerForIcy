...
public class ShowFlagsPanel extends JLayeredPane {
	...
	public void createCheckboxes() {
		...
		showCamerasCheckBox_.setFont(new Font("", 0, 10));
		...
		showShuttersCheckBox_.setFont(new Font("", 0, 10));
		...
		showStagesCheckBox_.setFont(new Font("", 0, 10));
		...
		showStateDevicesCheckBox_.setFont(new Font("", 0, 10));
		...
		showOtherCheckBox_.setFont(new Font("", 0, 10));
	...
	protected void initializeCheckboxes() {
		try {
			...
			for (int i = 0; (long) i < initialCfg_.size(); i++) {
