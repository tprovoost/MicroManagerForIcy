...
public class PropertyEditor extends IcyFrame
{
    ...
    public PropertyEditor(MMMainFrame gui)
    {
        ...
        refreshButton.setIcon(SwingResourceManager.getIcon(PropertyEditor.class,
    ...
    public void setCore(CMMCore core)
    {
        ...
        table.addColumn(new TableColumn(1, 200, new PropertyValueCellRenderer(false),
                new PropertyValueCellEditor(false)));
    ...
    public class PropertyEditorTableData extends PropertyTableData
    {
        ...
        public PropertyEditorTableData(CMMCore core, String groupName, String presetName, int PropertyValueColumn,
